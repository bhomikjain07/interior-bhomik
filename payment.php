...
{
    $t=0;
    if(!empty($_POST['t1'])&& is_numeric($_POST['t2']))
    {
    ...
    if($t==0)
{
    ...
    if($con==true)
    {
        $q="insert into billing values($cn,$ex,'$nm')";
        $t=$con->query($q);
...
<div class="container">
        <!-- <div class="row">
                                        ...
                                        if($t->num_rows>0)
                                        {
                                            while($row = $t->fetch_assoc()) {
                                                ...
                                                <p class='mb-0'>
                                                    ...
                                                    <span class='c-green'>".$row['amount']."</span>
                                                </p>
            ...
            <div class="col-12">
                <input type=submit class="btn btn-primary payment" value="PAY NOW" name=b1  >
